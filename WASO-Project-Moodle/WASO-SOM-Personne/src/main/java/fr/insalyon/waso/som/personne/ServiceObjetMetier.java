...
public class ServiceObjetMetier {
    ...
    public void rechercherPersonneParNom(String nomPersonne)  throws ServiceException {
        try {
            List<Object[]> listePersonne = this.dBConnection.launchQuery("SELECT PersonneID, Nom, Prenom, Mail FROM PERSONNE WHERE Nom = ? ORDER BY PersonneID",nomPersonne);
    ...
    public void identifierPersonne(String idPersonne) throws ServiceException {
        try {
