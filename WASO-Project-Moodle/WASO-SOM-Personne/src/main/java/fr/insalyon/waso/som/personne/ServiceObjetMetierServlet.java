...
public class ServiceObjetMetierServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            }else if("identifierPersonne".equals(som)) {
             String idPersonneParameter = request.getParameter("id-personne");
             if(idPersonneParameter == null){
                 throw new ServiceException("Paramètres incomplets, ajoutez un id");
             }
             String idPersonne = idPersonneParameter;
             
             service.identifierPersonne(idPersonne);
            }
            else {
